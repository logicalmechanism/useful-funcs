...
-- Testing: Test.Groups.Address
-------------------------------------------------------------------------------
{-# INLINABLE isAddrHoldingExactlyToken #-}
isAddrHoldingExactlyToken :: [V2.TxOut] -> V2.Address -> V2.CurrencySymbol -> V2.TokenName -> Integer -> Bool
...
-- Testing: Test.Groups.Address
-------------------------------------------------------------------------------
{-# INLINABLE isAddrHoldingAtLeastToken #-}
isAddrHoldingAtLeastToken :: [V2.TxOut] -> V2.Address -> V2.CurrencySymbol -> V2.TokenName -> Integer -> Bool
isAddrHoldingAtLeastToken []     _    _   _   _   = False
isAddrHoldingAtLeastToken (x:xs) addr pid tkn val
  | checkAddr && checkVal = True
  | otherwise             = isAddrHoldingAtLeastToken xs addr pid tkn val 
  where
    checkAddr :: Bool
    checkAddr = V2.txOutAddress x == addr

    checkVal :: Bool
    checkVal = Value.valueOf (V2.txOutValue x) pid tkn >= val -- greater than or equal
-------------------------------------------------------------------------------
